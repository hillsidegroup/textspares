...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr><td >
        	 <table cellpadding="0" cellspacing="0" width="100%" border="0">
        	 	<tr><td><a href="index.php" class='toplinks'>Home</a> > <a href="terms.php" class='toplinks'>Terms & Coditions </a></td></tr>
        	 	<tr><td>&nbsp;</td></tr>
        	 	<!--<tr>
          <td>
              ...
              <td valign="top">
              	<table width="100%" border="0" align="center" cellpadding="1" cellspacing="0">
              		<tr><td>
              		<?
        	$sqld=mysql_query("select * from files where file_name='terms'")or die(mysql_error());
