...
$res_file['pageTitle'] = 'New and Used'.($meta_make ? ' '.($meta_make) : '').' Engines '.($meta_area ? $meta_area : 'UK');
top();
?>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr><td >
        	 <table cellpadding="0" cellspacing="0" width="100%" border="0">
        	 	<tr><td><a href="<?=BASE?>index.php" class='toplinks'>Home</a> > <a href="engine.php" class='toplinks'>Engine</a></td></tr>
        		<tr>
              <td valign="top">
              	<table width="100%" border="0" align="center" cellpadding="1" cellspacing="0">
              		<tr><td>
              		<?
              		$sqld=mysql_query("select * from files where file_name='engine'")or die(mysql_error());
